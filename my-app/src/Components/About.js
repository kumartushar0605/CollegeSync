...
`;
  ...
  const teamMembers = [
    ...
    { name: "Ayush Tripathi", role: "Full stack developer", imageUrl: at },
    { name: "Ayush", role: "Full stack developer", imageUrl: a },
  ];
      ...
      <VStack spacing={6} align="start">
        ...
        >
          ...
          <Text fontSize="xl" color={isDark ? "gray.200" : "gray.700"}>
            Welcome to College Connect, your go-to platform for asking questions
            and clearing doubts. Whether you're a student looking for help or a
            peer who can provide answers, this is the place where students can
        ...
        >
          ...
          <Text fontSize="md" color={isDark ? "gray.200" : "gray.700"}>
            College Connect aims to foster a collaborative learning environment
            where students can ask questions and get answers from their peers
            who are also teachers within the same college and globally. Here's
            what you can do:
          </Text>
          <VStack spacing={3} mt={4} align="start">
            ...
            <HStack>
              ...
              />
              <Text fontSize="md" color={isDark ? "gray.300" : "gray.700"}>
                Engage with your college mates.
              </Text>
            </HStack>
            <HStack>
              <Icon
